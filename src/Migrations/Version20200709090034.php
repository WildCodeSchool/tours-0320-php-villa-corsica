 ...
 */
final class Version20200709090034 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE villa (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, location LONGTEXT NOT NULL, description LONGTEXT NOT NULL, nb_room INT NOT NULL, nb_bed INT NOT NULL, nb_bathroom INT NOT NULL, capacity INT NOT NULL, sqm INT NOT NULL, poster LONGTEXT NOT NULL, price VARCHAR(400) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
