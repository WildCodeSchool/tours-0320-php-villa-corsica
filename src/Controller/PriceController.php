...
class PriceController extends AbstractController
{
    ...
    /**
     * @Route("/new/{id}", name="price_new", methods={"GET","POST"}, requirements={"id"="\d+"})
     */
    public function new(Request $request, Villa $villa): Response
    {
        $price = new Price();
    ...
    /**
     * @Route("/{id}", name="price_show", methods={"GET"}, requirements={"id"="\d+"})
     */
